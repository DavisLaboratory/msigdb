...
#' The MSigDB v7.1 (Using gene symbols)
#'
#' The molecular signatures database (MSigDB) is a collection of over 25000 gene
#' expression signatures. Signatures in v7.1 are divided into 8 categories. Gene
#' expression signatures are represented using gene symbols.
#'
...
#' The MSigDB v7.1 (Using Entrez IDs)
#'
#' The molecular signatures database (MSigDB) is a collection of over 25000 gene
#' expression signatures. Signatures in v7.1 are divided into 8 categories. Gene
#' expression signatures are represented using Entrez IDs.
#'
#' @format A GeneSetCollection object composed of GeneSet objects representing
#'   all non-empty gene expression signatures from the molecular signatures
#'   database (MSigDB).
