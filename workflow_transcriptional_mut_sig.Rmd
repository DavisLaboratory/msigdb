...
The third mode is suitable for this application. The median absolute deviation is the default choice of a dispersion measure as it is non-parametric.
...
Diagnostics of the signature relative to the samples {#diagnostics_verhaak}
----------------------------------------------------

Investigate the contribution of each signature, (up- and down-regulated genes) to the total score. Also look at the relationship between score and the median absolute deviation (MAD). We can project annotations such as mutation status.
