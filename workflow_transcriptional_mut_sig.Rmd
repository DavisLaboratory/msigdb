...
Creating signature landscapes using multiple signatures {#signature_landscape}
=======================================================

Score samples using an MLL fusion signature {#score_rossmll}
-------------------------------------------
...
Ross MLL fusion signature vs. Verhaak signature landscape {#sig_landscape_mll}
---------------------------------------------------------

```{r fig.cap="Signature landscape.", fig.height=7}
...
```{r fig.cap="Signature landscape with projections.", fig.height=7}
...
Ross PML-RARA fusion signature vs. Verhaak signature landscape {#sig_landscape_pmlrara}
--------------------------------------------------------------

```{r echo=FALSE, fig.cap="Signature landscape with projections.", fig.height=7}
